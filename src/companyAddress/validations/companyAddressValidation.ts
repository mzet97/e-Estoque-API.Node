...
// Schema para criação de company address
export const createCompanyAddressValidation = celebrate({
  [Segments.BODY]: Joi.object({
    type: Joi.string()
      .valid('headquarters', 'branch', 'warehouse', 'billing', 'shipping')
      .required()
      .messages({
        'string.empty': 'Type é obrigatório',
        'any.only': 'Type deve ser uma das opções: headquarters, branch, warehouse, billing, shipping',
    ...
    department: Joi.string()
      ...
      .allow('', null)
      .messages({
        'string.max': 'Department deve ter no máximo 100 caracteres'
      }),
    ...
    contactPerson: Joi.string()
      ...
      .allow('', null)
      .messages({
        'string.max': 'ContactPerson deve ter no máximo 255 caracteres'
      }),
    ...
    phone: Joi.string()
      ...
      .allow('', null)
      .messages({
        'string.pattern.base': 'Phone deve conter apenas números, hífens, parênteses e espaços',
        'string.max': 'Phone deve ter no máximo 20 caracteres'
      }),
    ...
    isHeadquarters: Joi.boolean()
      .default(false)
      .messages({
        'boolean.base': 'IsHeadquarters deve ser um boolean'
      }),
...
// Schema para atualização de company address
export const updateCompanyAddressValidation = celebrate({
...
export const listCompanyAddressesValidation = celebrate({
...
export const companyAddressIdValidation = celebrate({
  [Segments.PARAMS]: Joi.object({
    id: Joi.string()
      .uuid()
      .required()
...
// Schema para buscar empresa por endereço (get address)
export const getCompanyAddressValidation = celebrate({
  [Segments.PARAMS]: Joi.object({
    id: Joi.string()
      .uuid()
      .required()
  ...
  [Segments.QUERY]: Joi.object({
    includeCompany: Joi.boolean()
      .default(true)
      .messages({
        'boolean.base': 'IncludeCompany deve ser um boolean'
      })
  })
})
